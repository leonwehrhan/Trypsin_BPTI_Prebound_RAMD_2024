#
# THIS CODE WAS COPIED FROM: https://www.plumed.org/doc-v2.8/user-doc/html/lugano-2.html
#
...
#for i in range(0, len(ws)): log.write("%32.35lf\n" % ws[i])
#log.close()

with open("weights.dat", "w") as log:
    for i in range(len(ws)):
        log.write(np.format_float_scientific(ws[i]) + '\n')
